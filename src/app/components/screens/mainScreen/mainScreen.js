        ...
        <div className="main__inner">
          ...
          <div className="main__inner--left">
            ...
            <p className="main__inner--text">
              Мой опыт  работы <span>TEST TEST TEST TEST года</span>. Навыки в веб-сфере —  вёрстка и оптимизация сайта, разработка и адаптация веб-дизайна, а также ведение проектов
            </p>
